...
},{"./data.json":29}],27:[function(require,module,exports) {
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e=function(){function e(e,t){for(var n=0;n<t.length;n++){var o=t[n];o.enumerable=o.enumerable||!1,o.configurable=!0,"value"in o&&(o.writable=!0),Object.defineProperty(e,o.key,o)}}return function(t,n,o){return n&&e(t.prototype,n),o&&e(t,o),t}}(),t=require("../controller"),n=a(t),o=require("../utils/events"),r=a(o),u=require("../utils/dom"),i=require("../utils/helpers");function a(e){return e&&e.__esModule?e:{default:e}}function c(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}var l=function(){function t(){c(this,t),this.vdom=null,this.render(),this.bindEvents()}return e(t,[{key:"bindEvents",value:function(){var e=this;document.getElementById("console-selector").addEventListener("click",function(e){document.getElementById("command-input").focus()}),r.default.on("consoleViewRender",function(t){e.render()}),window.addEventListener("keyup",function(e){var t=n.default.getKeyCommands().find(function(t){return t.shortcut?t.code===e.which&&e[t.shortcut]:t.code===e.which});t&&"command-input"===document.activeElement.id&&n.default.executeKeypress(t.action)})}},{key:"render",value:function(){var e=(0,u.h)("div",null,(0,u.h)("ul",{className:"console__command-list"},n.default.getPreviousCommands().map(function(e){return(0,u.h)("li",{className:"console__command-list-item console__command-list-item--"+e.type},"command"===e.type?"$ "+e.text:e.text)})),(0,u.h)("form",{onSubmit:function(e){e.preventDefault(),n.default.enterCommand(e.target.prompt.value),e.target.prompt.value=""}},(0,u.h)("span",null,"$ "),(0,u.h)("input",{type:"text",name:"prompt",id:"command-input",className:"console__prompt",autocomplete:"off",value:n.default.getEnteredCommands().text,forceUpdate:!0})));this.vdom=(0,u.render)(document.getElementById("commands"),e,this.vdom),document.getElementById("command-input").focus()}}]),t}();exports.default=l;
},{"../controller":27,"../utils/events":21,"../utils/dom":26,"../utils/helpers":22}],19:[function(require,module,exports) {
