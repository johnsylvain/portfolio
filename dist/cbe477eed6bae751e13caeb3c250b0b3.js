...
},{"./data.json":26}],22:[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e=require("../utils/events"),t=o(e),n=require("../data"),a=o(n);function o(e){return e&&e.__esModule?e:{default:e}}function r(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}var d={init:function(){a.default.currentOutput=a.default.defaultMessage},getCurrentOutput:function(){return a.default.currentOutput},updateOutput:function(e){a.default.currentOutput=e},executeKeypress:function(e){if("UP"===e||"DOWN"===e){"UP"===e&&a.default.enteredCommands.pointer<a.default.enteredCommands.data.length&&(a.default.enteredCommands.pointer+=1),"DOWN"===e&&a.default.enteredCommands.pointer>0&&(a.default.enteredCommands.pointer-=1);var n=a.default.enteredCommands.data.length-a.default.enteredCommands.pointer;a.default.enteredCommands.currentCommand=a.default.enteredCommands.data[n]}"CLEAR"===e&&this.executeCommand("clear"),t.default.emit("consoleViewRender")},getKeyCommands:function(){return a.default.keyCommands},getEnteredCommands:function(){return a.default.enteredCommands.currentCommand?a.default.enteredCommands.currentCommand:{text:""}},getCommand:function(e){return a.default.commands.find(function(t){return t.text===e})},getCommandList:function(){return a.default.commandList},getFileName:function(){return Object.keys(a.default.currentOutput)[0]},enterCommand:function(e){var n=(e=e.trim()).split(" ");if(""!==n[0]){var o={text:e,type:"command"};a.default.commandList.push(o);var r=a.default.enteredCommands.data[a.default.enteredCommands.data.length-1];r?e!==r.text&&a.default.enteredCommands.data.push(o):a.default.enteredCommands.data.push(o),a.default.enteredCommands.pointer=0}a.default.commands.find(function(e){return e.text===n[0]})?this.executeCommand(e):a.default.commandList.push({text:"command not found: "+n[0],type:"error"},{text:"to view available commands type: help",type:"response"}),t.default.emit("consoleViewRender")},executeCommand:function(e){var n=this,o=e.split(" "),u=function(e,t){o.length===e||a.default.commandList.push({text:"'"+t+"' does not need any arguments",type:"error"})},m={pwd:function(){u(d.getCommand("pwd").params||1,"pwd"),a.default.commandList.push({text:window.location.host,type:"bold"})},ls:function(){u(d.getCommand("ls").params||1,"ls"),a.default.commandList.push({text:"index.html",type:"response"},{text:"app.js",type:"response"},{text:"style.css",type:"response"})},clear:function(){u(d.getCommand("clear").params||1,"clear"),a.default.commandList=[]},help:function(){u(d.getCommand("help").params||1,"help");var e=a.default.commands;a.default.commandList.push({text:"Available Commands:",type:"bold"}),e.forEach(function(e,t){if(!0!==e.ignored&&""!==e.text){var n=null!==e.params?"- "+e.text+" ["+e.params.toLocaleString()+"]":"- "+e.text;a.default.commandList.push({text:n,type:"response"})}})},open:function(){if(1!==o.length)return{resume:function(){n.updateOutput({resume:a.default.data})},pdf:function(){window.open("http://johnsylvain.me/resume.pdf")}};a.default.commandList.push({text:"type 'open ["+d.getCommand("open").params+"]'",type:"warning"})},show:function(){var e=function(e){return function(){n.updateOutput(r({},e,a.default.data[e]))}};if(1!==o.length)return{education:e("education"),skills:e("skills"),xp:e("experience"),projects:e("projects")};a.default.commandList.push({text:"type 'show ["+d.getCommand("show").params+"]'",type:"warning"})},email:function(){for(var e="",t=1;t<o.length;t++)e+=" "+o[t];window.open("mailto:hi@johnsylvain.me?subject="+e)},social:function(){var e=function(e){return function(){window.open(a.default.data.contact.social[e])}};if(1!==o.length)return{github:e("github"),linkedin:e("linkedin")};a.default.commandList.push({text:"type 'social ["+d.getCommand("social").params+"]'",type:"warning"})},rm:function(){if(1!==o.length)return{"-rf":function(){var e=[document.querySelector("#wrapper"),document.querySelectorAll(".trash")];document.querySelector("#command-input").disabled=!0,e.forEach(function(e){Array.from(e)[0]?e.forEach(function(e){e.classList.add("crash")}):e.classList.add("crash")}),window.setTimeout(function(){document.querySelector("#command-input").disabled=!1,e.forEach(function(e){Array.from(e)[0]?e.forEach(function(e){e.classList.remove("crash")}):e.classList.remove("crash")}),document.querySelector("#command-input").focus()},4e3)}};a.default.commandList.push({text:"error",type:"error"})}};if(a.default.enteredCommands.pointer=0,a.default.enteredCommands.currentCommand="",""===o[0])a.default.commandList.push({text:"",type:"command"});else if(1===o.length||"email"===o[0])m[o[0]]();else if(o.length>1){var s=m[o[0]]();s[o[1]]?s[o[1]]():a.default.commandList.push({text:o[1]+" is not a proper parameter of '"+o[0]+"'",type:"error"})}t.default.emit("resumeContentViewRender"),t.default.emit("consoleViewRender")}};exports.default=d;
},{"../utils/events":12,"../data":25}],23:[function(require,module,exports) {
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e};function t(e,t){for(var n=arguments.length,r=Array(n>2?n-2:0),o=2;o<n;o++)r[o-2]=arguments[o];return r=[].concat.apply([],r),t=t||{},"function"==typeof e?e(t,r):{nodeName:e,attributes:t,children:r}}function n(e,t,n){f(e,d(t,n))}function r(e){var t="string"==typeof e||"number"==typeof e?document.createTextNode(e):document.createElement(e.nodeName);return e.attributes&&(i(t,e.attributes),e.children.map(r).forEach(t.appendChild.bind(t))),t}function o(e,t,n){"className"===t?e.setAttribute("class",n):"__html"===t?e.innerHTML=n:e.setAttribute(t,n)}function a(e,t,n){"className"===t?e.remove("class"):"__html"===t?e.innerHTML="":e.removeAttribute(t)}function i(e,t){for(var n in t)/^on/.test(n)?u(e,n,t[n]):o(e,n,t[n])}function u(e,t,n){e.addEventListener(t.slice(2).toLowerCase(),n)}function c(e,t){for(var n=[],r=Math.max(e.children.length,t.children.length),o=0;o<r;o++)n[o]=d(e.children[o],t.children[o]);return n}function s(e,t){var n=[],r=Object.assign({},e.attributes,t.attributes);return Object.keys(r).forEach(function(r){var o=e.attributes[r],a=t.attributes[r];o?a&&a===o||n.push({type:"SET_ATTRIBUTE",name:r,value:o}):n.push({type:"REMOVE_ATTRIBUTE",name:r,value:a})}),n}function d(e,t){return t?e?p(e,t)?{type:"REPLACE",newNode:e}:e.nodeName?{type:"UPDATE",children:c(e,t),attributes:s(e,t)}:void 0:{type:"REMOVE"}:{type:"CREATE",newNode:e}}function l(e,t){for(var n=0;n<t.length;n++){var r=t[n],i=r.type,u=r.name,c=r.value;"SET_ATTRIBUTE"===i?o(e,u,c):"REMOVE_ATTRIBUTE"===i&&a(e,u,c)}}function f(e,t){var n=arguments.length>2&&void 0!==arguments[2]?arguments[2]:0;if(t){var o=e.childNodes[n];switch(t.type){case"CREATE":var a=r(t.newNode);return e.appendChild(a);case"REMOVE":return e.removeChild(o);case"REPLACE":var i=r(t.newNode);return e.replaceChild(i,o);case"UPDATE":var u=t.children;l(o,t.attributes);for(var c=0;c<u.length;c++)f(o,u[c],c)}}}function p(t,n){return(void 0===t?"undefined":e(t))!==(void 0===n?"undefined":e(n))||"string"==typeof t&&t!==n||t.nodeName!==n.nodeName||t.attributes&&t.attributes.forceUpdate}exports.h=t,exports.render=n;
},{}],13:[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e=function(){function e(e,r){for(var n=0;n<r.length;n++){var t=r[n];t.enumerable=t.enumerable||!1,t.configurable=!0,"value"in t&&(t.writable=!0),Object.defineProperty(e,t.key,t)}}return function(r,n,t){return n&&e(r.prototype,n),t&&e(r,t),r}}(),r=require("../controller"),n=c(r),t=require("../utils/events"),u=c(t),i=require("../utils/filters"),l=s(i),a=require("../utils/helpers"),o=require("../utils/vdom");function s(e){if(e&&e.__esModule)return e;var r={};if(null!=e)for(var n in e)Object.prototype.hasOwnProperty.call(e,n)&&(r[n]=e[n]);return r.default=e,r}function c(e){return e&&e.__esModule?e:{default:e}}function f(e,r){if(!(e instanceof r))throw new TypeError("Cannot call a class as a function")}var d=function(){function r(){f(this,r),this.vdom=null,this.render(),this.bindEvents()}return e(r,[{key:"bindEvents",value:function(){var e=this;u.default.on("resumeContentViewRender",function(r){e.render()})}},{key:"render",value:function(){var e=n.default.getCurrentOutput(),r=(0,a.compose)(function(e){return JSON.stringify(e,null,"   ")},l.textToJSON,l.findUrls)(e),t=(0,o.h)("div",null,(0,o.h)("div",{className:"menu-bar clearfix"},(0,o.h)("div",{className:"menu-bar__circle"}),(0,o.h)("div",{className:"menu-bar__circle"}),(0,o.h)("div",{className:"menu-bar__circle"}),(0,o.h)("span",{className:"menu-bar__title"},n.default.getFileName(),".json")),(0,o.h)("div",{id:"resume-content"},(0,o.h)("pre",{__html:r})));(0,o.render)(document.querySelector("#resume-wrapper"),t,this.vdom),this.vdom=t}}]),r}();exports.default=d;
},{"../controller":22,"../utils/events":12,"../utils/filters":23,"../utils/helpers":14,"../utils/vdom":24}],15:[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e=function(){function e(e,t){for(var n=0;n<t.length;n++){var o=t[n];o.enumerable=o.enumerable||!1,o.configurable=!0,"value"in o&&(o.writable=!0),Object.defineProperty(e,o.key,o)}}return function(t,n,o){return n&&e(t.prototype,n),o&&e(t,o),t}}(),t=require("../controller"),n=c(t),o=require("../utils/events"),r=c(o),u=require("../utils/vdom");function c(e){return e&&e.__esModule?e:{default:e}}function a(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}var i=function(){function t(){a(this,t),this.vdom=null,this.render(),this.bindEvents()}return e(t,[{key:"bindEvents",value:function(){var e=this;document.getElementById("console-selector").addEventListener("click",function(e){document.getElementById("command-input").focus()}),r.default.on("consoleViewRender",function(t){e.render()}),window.addEventListener("keyup",function(e){var t=n.default.getKeyCommands().find(function(t){return t.shortcut?t.code===e.which&&e[t.shortcut]:t.code===e.which});t&&"command-input"===document.activeElement.id&&n.default.executeKeypress(t.action)})}},{key:"render",value:function(){var e=n.default.getCommandList(),t=(0,u.h)("div",null,(0,u.h)("ul",{className:"console__command-list",forceUpdate:0===e.length},e.map(function(e){return(0,u.h)("li",{className:"console__command-list-item console__command-list-item--"+e.type},"command"===e.type?"$ "+e.text:e.text)})),(0,u.h)("form",{onSubmit:function(e){e.preventDefault(),n.default.enterCommand(e.target.prompt.value),e.target.prompt.value=""}},(0,u.h)("span",null,"$ "),(0,u.h)("input",{type:"text",name:"prompt",id:"command-input",className:"console__prompt",autocomplete:"off",value:n.default.getEnteredCommands().text,forceUpdate:!0})));(0,u.render)(document.querySelector("#commands"),t,this.vdom),this.vdom=t,document.querySelector("#command-input").focus()}}]),t}();exports.default=i;
},{"../controller":22,"../utils/events":12,"../utils/vdom":24}],10:[function(require,module,exports) {
