...
},{"../utils/events":20,"../data":29,"../../data.json":28}],25:[function(require,module,exports) {
...
},{"../controller":26,"../utils/events":20,"../utils/filters":25,"../utils/helpers":22}],27:[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e};function t(e,t){for(var r=arguments.length,n=Array(r>2?r-2:0),o=2;o<r;o++)n[o-2]=arguments[o];return{nodeName:e,attributes:t,children:[].concat.apply([],n)}}function r(e){if("string"==typeof e)return document.createTextNode(e);var t=document.createElement(e.nodeName);for(var n in Object(e.attributes))t.setAttribute("className"===n?"class":n,e.attributes[n]);for(var o=0;o<e.children.length;o++)t.appendChild(r(e.children[o]));return t}function n(t,r){return(void 0===t?"undefined":e(t))!==(void 0===r?"undefined":e(r))||"string"==typeof t&&t!==r||t.nodeName!==r.nodeName}function o(e,t,i){var d=arguments.length>3&&void 0!==arguments[3]?arguments[3]:0;if(i)if(t){if(n(t,i))e.replaceChild(r(t),e.childNodes[d]);else if(t.nodeName)for(var l=t.children.length,c=i.children.length,a=0;a<l||a<c;a++)o(e.childNodes[d],t.children[a],i.children[a],a)}else e.removeChild(e.childNodes[d]);else e.appendChild(r(t));return t}exports.h=t,exports.render=o;
},{}],24:[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e=require("../controller"),t=i(e),n=require("../utils/events"),o=i(n),s=require("../utils/dom");function i(e){return e&&e.__esModule?e:{default:e}}o.default.on("consoleViewInit",function(e){m.init()}),o.default.on("consoleViewRender",function(e){m.render()});var m={init:function(){this.vdom=null,this.elements={promptContainer:document.getElementById("command-prompt-container"),listItemsContainer:document.getElementById("commands"),consoleContainer:document.getElementById("console-selector"),promptInput:document.getElementById("command-input")},this.bindEvents(),this.render()},bindEvents:function(){var e=this;this.elements.consoleContainer.addEventListener("click",function(){e.elements.promptInput.focus()}),this.elements.promptContainer.addEventListener("submit",function(e){e.preventDefault(),t.default.enterCommand(e.target.prompt.value),e.target.prompt.value=""})},render:function(){var e=t.default.getPreviousCommands();t.default.getEnteredCommands()?this.elements.promptInput.value=t.default.getEnteredCommands().text:this.elements.promptInput.value="";var n=(0,s.h)("ul",{className:"console__command-list"},e.map(function(e){return(0,s.h)("li",{className:"console__command-list-item console__command-list-item--"+e.type},"command"===e.type?"$ "+e.text:e.text)}));this.vdom=(0,s.render)(this.elements.listItemsContainer,n,this.vdom)}};exports.default=m;
},{"../controller":26,"../utils/events":20,"../utils/dom":27}],19:[function(require,module,exports) {

},{"./../img/code.svg":["6b2464138e6007a5b2cbb14c4297f053.svg",31],"./../img/close.svg":["a717742370bca4696c981b24803ddc0d.svg",30]}],18:[function(require,module,exports) {
"use strict";var e=require("./utils/router"),t=l(e),n=require("./utils/events"),i=l(n),r=require("./utils/helpers"),o=require("./controller"),s=l(o),c=require("./views/resumeContent"),d=l(c),a=require("./views/console"),u=l(a);function l(e){return e&&e.__esModule?e:{default:e}}require("../styles/style.scss");var f={pageWidth:window.innerWidth,breakpoint:768,interactiveMode:!1,init:function(){var e=this;s.default.init();var n=[{path:"/",controller:function(){i.default.emit("switchModes",{flag:!0})}},{path:"/resume",controller:function(){i.default.emit("switchModes",{flag:!1}),window.innerWidth<=e.breakpoint&&o.go({route:"#/"})}}],o=new t.default(n);window.addEventListener("keyup",this.handleKeypress.bind(this)),Array.from(document.getElementsByClassName("toggle-btn")).forEach(function(e){e.addEventListener("click",function(e){e.preventDefault(),o.go({route:e.target.href})})}),window.addEventListener("resize",(0,r.throttle)(function(t){window.innerWidth<=e.breakpoint&&o.go({route:"#/"})},250,this)),i.default.on("switchModes",function(t){e.switchModes(t.flag)}),document.querySelector("#date-selector").textContent=(new Date).getFullYear().toString()},handleKeypress:function(e){var t=s.default.getKeyCommands().find(function(t){return t.shortcut?t.code===e.which&&e[t.shortcut]:t.code===e.which});t&&s.default.executeKeypress(t.action)},switchModes:function(e){var t=document.getElementById("toggle-interactive"),n=[document.getElementById("page-wrap"),document.getElementById("landing-wrapper"),document.getElementById("resume-wrapper"),document.getElementById("console-selector"),document.getElementById("container"),document.getElementById("toggle-interactive")];if(e)return n.forEach(function(e){e.classList.remove("interactiveMode"),e.classList.add("nonInteractiveMode")}),this.interactiveMode=!1,void t.setAttribute("href","#/resume");this.interactiveMode?(n.forEach(function(e){e.classList.remove("interactiveMode"),e.classList.add("nonInteractiveMode")}),t.setAttribute("href","#/resume")):(n.forEach(function(e){e.classList.add("interactiveMode"),e.classList.remove("nonInteractiveMode")}),t.setAttribute("href","#/")),this.interactiveMode=!this.interactiveMode}};f.init();
},{"./utils/router":21,"./utils/events":20,"./utils/helpers":22,"./controller":26,"./views/resumeContent":23,"./views/console":24,"../styles/style.scss":19}]},{},[18])